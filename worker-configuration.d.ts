/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 06355867dd761d9003ff4f1f8be7f436)
// Runtime types generated with workerd@1.20260730.1 2026-08-05 nodejs_compat
interface __BaseEnv_Env {
	PUBLIC_BASE_URL: "https://cup-signal-x402.mcy23.workers.dev";
	INJECTIVE_RPC_URL: "https://testnet.evm.archival.chain.virtual.json-rpc.injective.network/";
	RECEIVER_ADDRESS: "0x0C69f390Da3e0B35570F031c0878e9F000cf5D84";
	RECEIPTS: DurableObjectNamespace<import("./worker/x402-api").ReceiptStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/x402-api");
		durableNamespaces: "ReceiptStore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BASE_URL" | "INJECTIVE_RPC_URL" | "RECEIVER_ADDRESS">> {}
}
